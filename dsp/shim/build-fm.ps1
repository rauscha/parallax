...
$em_flags = @(
  ...
  "-s", "FILESYSTEM=0",
  "-s", "MALLOC=emmalloc",
  "-s", "EXPORTED_FUNCTIONS=['_fm_init','_fm_set_patch','_fm_update_patch','_fm_note_on','_fm_note_off','_fm_set_pitch_bend','_fm_alloc','_fm_free','_fm_block_size','_fm_render','_fm_tap_count','_fm_tap_alloc','_fm_tap_free','_fm_set_tap_buffer','_malloc','_free']",
